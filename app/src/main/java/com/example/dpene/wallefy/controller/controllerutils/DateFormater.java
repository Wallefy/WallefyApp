...
public class DateFormater {
    ...
    //    from 2016-04-19 23:06:16 to 19 Apr, 2016
    public static String from_yyyyMMddHHmmss_To_dMMMyyyy(String dateToFormat) {
        if (dateToFormat == null || dateToFormat.equals(""))
            return "";
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Date date = new Date();
    ...
    //    from 9 Apr, 2016 - 23:06:16  to 9 Apr, 2016
    public static String from_dMMMyyyyHHMMSS_To_dMMMyyyy(String dateToFormat) {
        if (dateToFormat == null || dateToFormat.equals(""))
            return "";
